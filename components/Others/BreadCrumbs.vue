  ...
  <div class="breadcrumbs sb-noselect">
    <ul class="breadcrumbs__items">
      <li class="breadcrumbs__item">
        ...
        <NuxtLink class="breadcrumbs__item-link" to="/">Главная</NuxtLink>
      </li>
      <li class="breadcrumbs__item">
        <div class="breadcrumbs__item-icon">
          <svg
        ...
        <NuxtLink class="breadcrumbs__item-link" to="/blog">Блог</NuxtLink>
      </li>
      <li class="breadcrumbs__item">
        <div class="breadcrumbs__item-icon">
          <svg
...
export default {
  ...
  mounted() {
    this.mediaQueryHook(() => {
      this.scrumbsPageName = this.isMobile
